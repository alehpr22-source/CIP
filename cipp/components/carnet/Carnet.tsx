...
export function Carnet({
  ...
  return (
    <div className="flex flex-col items-center gap-6">
      <div
        ref={cardRef}
        className="relative w-[500px] overflow-hidden rounded-xl border-4 border-yellow-600 bg-white shadow-lg"
        style={{ fontFamily: "Arial, Helvetica, sans-serif" }}
      >
        {inhabilitado && (
          <div className="pointer-events-none absolute inset-0 z-10 flex items-center justify-center">
            <div
              className="-rotate-12 select-none text-center text-5xl font-black tracking-[0.25em] text-red-600 opacity-30"
        ...
        {/* Header */}
        <div className="bg-blue-900 px-8 py-3 text-center text-white">
        ...
        <div className="flex px-8 py-4">
          ...
          <div className="mr-4 flex-shrink-0">
            <div className="h-44 w-40 overflow-hidden rounded-lg border-2 border-gray-200 bg-gray-100">
              {fotoUrl ? (
                <img
                  src={fotoUrl}
                  alt="Foto"
          ...
          <div className="flex flex-1 flex-col justify-center">
            <p className="text-2xl font-bold uppercase leading-tight text-gray-900">
              {apellidoPaterno}
            </p>
            <p className="text-2xl font-bold uppercase leading-tight text-gray-900">
              {apellidoMaterno}
            </p>
            <p className="text-lg font-semibold uppercase leading-tight text-gray-800">
              {nombres}
            </p>
        ...
        {/* Footer with CIP */}
        <div className="border-t border-gray-200 bg-gray-50 px-8 py-2 text-right">
